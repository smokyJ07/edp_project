...
#signing into firebase database for app communication
cred = credentials.Certificate('app-8a197-firebase-adminsdk-kjbb6-c833e93110.json')
default_app = firebase_admin.initialize_app(cred)

# Get a database reference to our blog.
ref = db.reference(url="https://app-8a197.firebaseio.com/")
strings_ref = ref.child('animal')

while(True):
	d = strings_ref.get()
	if len(d) > 1:
		print(d)
		strings_ref.update({'animal': ''})
